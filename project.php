                                ...
                                <table class="table table-borderless table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = pg_fetch_assoc($result)) {
                                            echo "<tr>" .
                                                "<td>";
                                            echo  $i . "</td>" . "<td><button"; ?> onclick="showdata('<?php echo $row['title'] ?>','<?php echo $row['start_date'] ?>','<?php echo $row['end_date'] ?>','<?php echo $row['objective'] ?>','<?php echo $row['technology'] ?>')" data-toggle='modal' data-target='#projectmodal'>
...
<div class="modal fade" id="updatemodal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    ...
    <script>
        function showdata(title, s_date, e_date, obje, tech) {
